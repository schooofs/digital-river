...
class ResourceBox
{
  ...
  {
    if($post_type === "videos") {  
      return __("Video", "digital-river-2019");  
    } else if($post_type === "press_release"){
      return __("Press Release", "digital-river-2019");  
    } else if($post_type === "Webinar"){
      return __("Webinar", "digital-river-2019");  
    } else if($post_type === "events"){
      return __("Event", "digital-river-2019");  
    } else if($post_type === "blog" || $post_type === "post"){
      return __("Blog", "digital-river-2019");  
    } else if($post_type === "case_study"){
      return __("Case Study", "digital-river-2019"); 
    } else if($post_type === "web_page"){
      return __("Web Page", "digital-river-2019");   
    } else if($post_type === "white_paper"){
      return __("White Paper", "digital-river-2019");  
    } else if($post_type === "infographic"){
      return __("Infographic", "digital-river-2019");  
    } else if($post_type === "value_brief"){
      return __("Value Brief", "digital-river-2019");  
    } else if($post_type === "news"){
      return __("News", "digital-river-2019"); 
    } else if($post_type === "report"){
      return __("Report", "digital-river-2019");
    } 
        else {
      return __("Resource", "digital-river-2019");  
    }
  }
