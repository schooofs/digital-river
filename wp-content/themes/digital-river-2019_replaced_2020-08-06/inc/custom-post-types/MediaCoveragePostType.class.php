...
class MediaCoveragePostType{

    public static $post_type_key = 'media_coverage';
    public static $post_type_plural_name = 'Media Coverage';
    public static $post_type_singular_name = 'Media Coverage';
