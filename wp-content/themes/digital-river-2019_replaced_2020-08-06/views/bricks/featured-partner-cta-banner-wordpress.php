<?php
    ...
    // information for WordPress since there's a bug where adding information into a brick
    ...
    //
    // This is being done as a form of technical debt because we need to launch quickly.
?> 
<style> 
    ...
    <div class="container">
        <div class="row flex">
            <div class="col-sm-12 col-md-8 pt-5 pl-5 pr-5" style="background-color: #399ae1;">
                ...
                <form id="mktoForm_6613"></form>
                <script>MktoForms2.loadForm("//app-sj03.marketo.com", "348-QUY-258", 6613);</script>
            </div>
            <div class="col-3 d-xs-none d-sm-none d-md-block pt-5 pr-5" style="background-color: #399ae1;">
                <img class="img-fluid" src="/wp-content/uploads/sites/8/renee.jpg"/>
                <p class="mt-3" style="color: <?= $body_text_colour ?>; font-size: 17px;">Renée Mendenhall<br>Director of Partnership Development</p>
            </div>
        </div>
    </div>
</div>
