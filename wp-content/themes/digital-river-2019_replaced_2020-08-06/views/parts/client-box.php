    ...
    <div class="outer-wrapper">
        <div class="trust-statement-wrapper" style="height:0px; position:relative;">
            <p class="lead"  style="position:absolute; bottom:0;">
                <?= $trust_statement ?>
                <br><span class="h4"><?= sprintf("%s %s %s", $name, __("trusts","digital-river-2019"), "Digital River") ?></span>
            </p>
         </div>
    </div>
      <?php else: ?>
         <div class="outer-wrapper" style="height:0px; position:relative;">
            <div class="trust-statement-wrapper" style="position:absolute; bottom:0;">
                <p class="lead client-feature-quote"><i><?= sprintf("%s%s%s",__('"','digital-river-2019'),$quote, __('"','digital-river-2019')) ?></i></p>
                <p class="h4"> <?= $author ?></p>
             </div>
        </div>
            <?php endif; ?>
