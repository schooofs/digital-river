...
<div class="brick">
  <div class="row pad-t-xxs-4 pad-b-xxs-4">
    <div class="col-md-8 col-md-offset-2 col-sm-offset-1">
      <h5 class="tag h1 marg-b-xxs-4"><?php _e('Search Results', 'digital-river-2019'); ?></h5>
      <p><?php echo $total_results ?> <?= __("results found for", "digital-river-2019") ?> "<?= htmlspecialchars($search->query['s']) ?>"</p>
      <div class="row">
        <?php if ($total_results < 1): ?>
          <div class="col-xxs-12">
            <h6 class="h6"><?php _e('Please check your spelling and/or refine your keywords' , 'digital-river-2019'); ?></h6>
            <form role="search" method="get" class="search-form form-inline marg-t-xxs-4" action="<?php echo esc_url( home_url( '/' ) ); ?>">
              <div class="form-group">
                ...
                </label><button type="submit" class="btn btn-primary btn-search"><span class="screen-reader-text"><?php echo _x( 'Search', 'submit button', 'digital-river-2019' ); ?></span></button>
              </div>
            </form>
          </div>
        <?php else: ?>
        <div class="col-sm-3 col-sm-push-9">
          <h6 class="h3"><?php _e('filter by', 'digital-river-2019'); ?></h6>
          <ul id="filterBy" class="list-unstyled sort marg-b-xxs-3">
            <li class="marg-b-xxs-1">
              ...
              <label for="all"><?php _e('All Pages', 'digital-river-2019'); ?></label>            
            </li>
            <li class="marg-b-xxs-1">
              <input type="radio" id="pages" name="filter" value="page">
              <label for="pages"><?php _e('Website Pages', 'digital-river-2019'); ?></label>            
            </li>
            <li>
              <input type="radio" id="blog" name="filter" value="post">
              <label for="blog"><?php _e('Blog Posts', 'digital-river-2019'); ?></label>
            </li>
          </ul>
        </div>
