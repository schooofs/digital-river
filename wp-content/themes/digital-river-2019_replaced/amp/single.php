...
<article class="amp-wp-article">
	...
	<header class="amp-wp-article-header">
	  ...
	  <p class="author-meta"><?php _e("By:  ", "digital-river-2019");the_field('main-author'); ?></p>
	</header>
	
	<div class="amp-wp-article-content">
		<p class="modified-date"><?php _e("Last modified: ","digital-river-2019") . the_modified_date('F j, Y'); ?></p>
		<hr>
