...
$yearBoxes.owlCarousel({
    ...
    nav:false,
    dots: false,
    // navText: ['<img width="50" height="50" src="/wp-content/themes/digital-river/assets/images/icons_ArrowSingleLeftWhite.svg" />','<img width="50" height="50" src="/wp-content/themes/digital-river/assets/images/icons_ArrowSingleRightWhite.svg" />'],
    margin:10,
    // autoplay:true,
