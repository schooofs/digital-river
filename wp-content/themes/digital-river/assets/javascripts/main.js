...
$('#success-slider').owlCarousel({
    ...
    center: true,
    nav: true,
    navText: ['<img width="50" height="50" src="/wp-content/themes/digital-river/assets/images/mycommerce/square-blue-arrow-left.svg" />','<img width="50" height="50" src="/wp-content/themes/digital-river/assets/images/mycommerce/square-blue-arrow-right.svg" />'],
    responsive:{
        0:{
            items:1
        },
