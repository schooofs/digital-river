		...
		<div class="bg-blue transparent marg-b-md-1">
	      <div class="row">
	         <div class="col-xxs-10 col-xxs-offset-1 col-lg-9 col-lg-offset-2 col-md-9 col-md-offset-2 pad-t-xxs-1 pad-b-md-1">
                <div class="h3 text-uppercase txt-white"><a href="/blog/" style="color: #ffffff !important;"><?= __(" Blog","digital-river") ?></a></div>
	        </div>
	      </div>
	    </div>
	      ...
	      <div class="row">
	        <div class="col-xxs-10 col-xxs-offset-1 col-md-9 col-md-offset-2">
	          <div>
                  ...
                  <div class="h4 txt-white"><?= __("By:  ", "digital-river") ?><?php the_author();  ?></div>
	          </div>
	        </div>
	      </div>
	    </div>
