	...
	<div class="row">
		<div class="col-xxs-10 col-xxs-offset-1">
		  ...
		  <ul class="nav nav-tabs" role="tablist">
		    <li role="presentation" class="active"><a href="#americas" aria-controls="americas" role="tab" data-toggle="tab"><?= __("Americas","digital-river") ?></a></li>
		    <li role="presentation"><a href="#emea" aria-controls="emea" role="tab" data-toggle="tab"><?= __("EMEA","digital-river") ?></a></li>
		    <li role="presentation"><a href="#apac" aria-controls="apac" role="tab" data-toggle="tab"><?= __("APAC","digital-river") ?></a></li>
		  </ul>
