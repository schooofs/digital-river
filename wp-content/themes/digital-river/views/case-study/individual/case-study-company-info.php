			...
			<div class="pad-b-xxs-4">
				<div class="row">
					<div class="col-md-4 col-lg-12">
						<small class="text-uppercase"> <?= __("Company", "digital-river") ?> </small>
						<div class="logo-wrapper pad-t-sm-2"> <?= $cs_logo ?> </div>
					</div>
					<div class="col-md-4 col-lg-12 marg-t-xxs-2 marg-t-md-0 marg-t-lg-2">
						<small class="text-uppercase"><?= __("Markets", "digital-river") ?></small>
						<div class="h4"><?= $cs_industry ?></div>
					</div>
				</div>
				<div class="row marg-t-md-6 marg-t-lg-2">
					<div class="col-md-4 col-lg-12 marg-t-xxs-2 marg-t-md-0 marg-t-lg-2">
						<div class="h4"><?= __("The Customer", "digital-river") ?></div>
						<p><?= $cs_the_customer ?></p>
					</div>
					<div class="col-md-4 col-lg-12 marg-t-xxs-2 marg-t-md-0 marg-t-lg-2">
						<div class="h4"><?= __("The Challenge", "digital-river") ?></div>
						<p><?= $cs_challenge ?></p>
					</div>
					<div class="col-md-4 col-lg-12 marg-t-xxs-2 marg-t-md-0 marg-t-lg-2">
						<div class="h4"><?= __("The Solution", "digital-river") ?></div>
						<p><?= $cs_solution ?></p>
					</div>
				</div>
			</div>
