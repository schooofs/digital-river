                ...
                <div class="client client-left even">
					<div class="client-logo-wrapper">
						<a href=" <?php echo get_page_link(8881); ?> ">
							<img alt='<?php _e( 'Branded Manufacturing Industry Icon', 'digital-river' ); ?>' class="client-logo" src="<?php echo get_image_path('Industries/Branded.png'); ?>" />
						</a>
					</div>
					...
					<div class="cta-wrapper">
							<a href=" <?php echo get_page_link(8881); ?> "><?php _e( '&#91; Learn More &#93;', 'digital-river' ); ?></a>
					</div>
                </div>
                <div class="client client-middle odd">
                	<div class="client-logo-wrapper">
                		<img alt='<?php _e( 'Entertainment Industry Icon', 'digital-river' ); ?>'  class="client-logo" src="<?php echo get_image_path('Industries/Entertainment.png'); ?>" />
                	</div>
                 ...
                 <div class="client client-right even">
                	<div class="client-logo-wrapper">
                		<a href="<?php echo get_page_link(8530); ?>">
                			<img alt='<?php _e( 'Gaming Industry Icon', 'digital-river' ); ?>' class="client-logo" src="<?php echo get_image_path('Industries/Gaming.png'); ?>">
                		</a>
                	</div>
                    ...
                    <div class="cta-wrapper">
							<a href=" <?php echo get_page_link(8530); ?> "><?php _e( '&#91; Learn More &#93;', 'digital-river' ); ?></a>
					</div>
                </div>
            </div>
                ...
                <div class="client client-left odd">
                	<div class="client-logo-wrapper">
                		<a href='<?php echo get_page_link(9158); ?>'>
                			<img alt='<?php _e( 'Retail Industry Icon', 'digital-river' ); ?>' class="client-logo" src="<?php echo get_image_path('Industries/Retail.png'); ?>" />
                		<a>
                	</div>
                    ...
                    <div class="cta-wrapper">
							<a href="<?php echo get_page_link(9158); ?> "><?php _e( '&#91; Learn More &#93;', 'digital-river' ); ?></a>
					</div>
                </div>
                 <div class="client client-middle even">
                	<div class="client-logo-wrapper">
                		<a href='<?php echo get_page_link(9109); ?>'>
                			<img alt='<?php _e( 'Software Industry Icon', 'digital-river' ); ?>' class="client-logo" src="<?php echo get_image_path('Industries/Software.png'); ?>" />
                		</a>
                	</div>
                    ...
                    <div class="cta-wrapper">
							<a href=" <?php echo get_page_link(9109); ?> "><?php _e( '&#91; Learn More &#93;', 'digital-river' ); ?></a>
					</div>
                </div>
                <div class="client client-right odd">
                	<div class="client-logo-wrapper">
                		<img alt='<?php _e( 'Travel and Leisure Industry Icon', 'digital-river' ); ?>' class="client-logo" src="<?php echo get_image_path('Industries/Travel.png'); ?>" />
                	</div>
                  ...
                  <div class="client client-left even" style='border-right:solid 1px #b1b1b1;'>
                	<div class="client-logo-wrapper">
                		<a href="<?php echo get_page_link(8472); ?>">
                			<img alt='<?php _e( 'Direct Selling Industry Icon', 'digital-river' ); ?>' class="client-logo" src="<?php echo get_image_path('Industries/DirectSelling.png'); ?>">
                		</a>
                	</div>
                    ...
                    <div class="cta-wrapper">
							<a href=" <?php echo get_page_link(8472); ?> "><?php _e( '&#91; Learn More &#93;', 'digital-river' ); ?></a>
					</div>
                </div>
