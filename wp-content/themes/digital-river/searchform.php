...
<form role="search" method="get" class="search-form form-inline pull-right" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<div class="form-group">
		...
		<button type="submit" class="btn btn-primary btn-search pull-left"><span class="screen-reader-text"><?php echo _x( 'Search', 'submit button', 'digital-river' ); ?></span></button>
	</div>
</form>