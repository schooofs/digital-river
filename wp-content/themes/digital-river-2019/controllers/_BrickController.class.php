...
class BrickController
{
    ...
    public static function river($brick_id, $brick_info)
    {
        ...
        View::make("bricks/river", [
            "anchor" => self::create_anchor(preg_replace('#[ -]+#', '-', $label)),
    ...
    public static function two_card($brick_id, $brick_info)
    {
        extract($brick_info);

        View::make("bricks/two-card", [
            "anchor" => self::create_anchor(preg_replace('#[ -]+#', '-', $label)),
            "progress_nav_enabled" => $progress_nav_enabled,
            "cards" => $cards
        ]);
    ...
    public static function home_hero($brick_id, $brick_info)
    {
        extract($brick_info);

        View::make("bricks/home-hero", [
            "anchor" => self::create_anchor(preg_replace('#[ -]+#', '-', $label)),
            "progress_nav_enabled" => $progress_nav_enabled,
            "heading" => $heading,
    ...
    public static function home_solutions($brick_id, $brick_info)
    {
        extract($brick_info);

        View::make("bricks/home-solutions", [
            "anchor" => self::create_anchor(preg_replace('#[ -]+#', '-', $label)),
            "progress_nav_enabled" => $progress_nav_enabled,
    ...
    public static function callouts_with_buttons($brick_id, $brick_info)
    {
        extract($brick_info);

        View::make("bricks/callouts-with-buttons", [
            "anchor" => self::create_anchor(preg_replace('#[ -]+#', '-', $label)),
            "progress_nav_enabled" => $progress_nav_enabled,
            "callouts" => $callouts,
            "background_color" => $background_color,
    ...
    public static function banner_with_logos($brick_id, $brick_info)
    {
        extract($brick_info);

        View::make("bricks/banner-with-logos", [
            "anchor" => self::create_anchor(preg_replace('#[ -]+#', '-', $label)),
            "progress_nav_enabled" => $progress_nav_enabled,
            "background_color" => $background_color,
            "heading" => $heading,
