...
function dr_is_new_page()
{
    ...
    $new_pages = [
        ...
        '19408', /* thank-you */
        '16196', /* careers */
        '19836', /* Salesforce B2b integration */ 
        '20076', /* Salesforce Partner Local */
        '20089', /* developer Partner Local */
        '20126' /* Salesforce Partner */
    ];
...
function is_not_production(){
 if($_SERVER['HTTP_HOST'] == "stg01dr.wpengine.com" || $_SERVER['HTTP_HOST'] == "dev01dr.wpengine.com" || $_SERVER['HTTP_HOST'] == "digitalriver.local"){
     return true;
 }
 return false;
}