...
class acf_field_template_widget_relationship extends acf_field
{
	// vars
	...
	*/
	...
	{
		// vars
		$this->name = 'template_widget_relationship';
		$this->label = __('Template Widget Relationship');
		$this->category = __("Widget",'acf'); // Basic, Content, Choice, etc
		$this->defaults = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		wp_register_script( 'acf-input-template_widget_relationship', $this->settings['dir'] . 'js/input.js', array('acf-input'), $this->settings['version'] );
		wp_register_style( 'acf-input-template_widget_relationship', $this->settings['dir'] . 'css/input.css', array('acf-input'), $this->settings['version'] ); 
		
		
		// scripts
		wp_enqueue_script(array(
			'acf-input-template_widget_relationship',	
		));
...
// create field
new acf_field_template_widget_relationship();
