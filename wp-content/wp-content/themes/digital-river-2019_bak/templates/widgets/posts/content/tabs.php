<div class="tabbed_post">
  <ul class="tab_menu">
    <li class="title">Title: <?php echo $posts['title']; ?></li>
        ...
        <ul class="content">
          <?php foreach ($tab as $content) : ?>
            <li class="listing">
              ...
              <a href="<?php echo get_permalink($content->ID); ?>" class="read_more">> Read More</a>
              <ul class="info">
                <?php if ($content->fields->publication_name) : ?>
                  <li><span class="name">Publication:</span> <?php echo $content->fields->publication_name; ?></li>
                <?php endif; ?>
                <?php if ($content->fields->author_name) : ?>
                  <li><span class="name">Author:</span> <?php echo $content->fields->author_name; ?></li>
                <?php endif; ?>
                <?php if ($content->fields->date_published) : ?>
                  <li><span class="name">Date published:</span> <?php echo $content->fields->date_published; ?></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endforeach; ?>
