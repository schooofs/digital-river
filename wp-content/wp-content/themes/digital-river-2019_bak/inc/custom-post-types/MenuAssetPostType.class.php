<?php
/**
 * Custom post type - Menu Asset
 *
 * @package digitalriver
 */
class MenuAssetPostType{

    public static $post_type_key = 'menu_asset';
    public static $post_type_plural_name = 'Menu Assets';
    public static $post_type_singular_name = 'Menu Asset';
