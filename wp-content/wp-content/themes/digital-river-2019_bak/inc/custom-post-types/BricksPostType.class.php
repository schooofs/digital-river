...
class BricksPostType
{
    ...
    public static $brickTypes = array(
        ...
        "featured_partner_hero_magento" => "Featured Partner Hero - Magento",
        "featured_partner_hero_wordpress" => "Featured Partner Hero - WordPress",
        ...
        "featured_partner_cta_banner_magento" => "Featured Partner CTA Banner - Magento",
        "featured_partner_cta_banner_wordpress" => "Featured Partner CTA Banner - WordPress",
