...
<?php get_header(); ?>
    <!-- Content Container -->
    <section id="corporate_policies" class="content_container">
    ...
    <div class="container"> 
        <div class="row">
            ...
            <!-- Sidebar -->
            <section class="rail span_4 col last">
                <section class="enhanced_text">
                    <h2><?php the_field('sidebar_title'); ?></h2>
                    <ul>
                        <?php foreach (get_field('sidebar_content') as $content) : ?>
                            <li><a href="<?php echo $content['link']; ?>"><?php echo $content['link_title']; ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </section>
            </section>
