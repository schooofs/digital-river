...
class WpeCommon extends WpePlugin_common {
	...
	**/
    ...
    public function is_request_proxied_by_cloudflare( $disable_maxcdn_for_cf_proxied_request ) {
	    if ( $disable_maxcdn_for_cf_proxied_request && array_key_exists('HTTP_CF_RAY', $_SERVER) ) {
	        return true;
	    }
	    return false;
    }
    ...
    public function get_cdn_domain( $netdna_config, $blog_url, $is_ssl ) {
        global $wpengine_platform_config, $disable_maxcdn_for_cf_proxied_request;
        ...
        $is_request_proxied =   $this->is_request_proxied_by_cloudflare( $disable_maxcdn_for_cf_proxied_request );
